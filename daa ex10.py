...
for case, arr in test_cases.items():
    d_comp, d_time = run_test("DQS", deterministic_quicksort, arr)
    r_comp, r_time = run_test("RQS", randomized_quicksort, arr)

    print(f'{case:<16} {d_comp:>12} {d_time:>14.2f} '
          f'{r_comp:>12} {r_time:>14.2f}')
